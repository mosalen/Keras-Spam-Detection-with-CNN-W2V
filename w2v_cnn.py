...
VECTOR_DIR = 'D:/TBdata/bert-base-chinese/bert-base-chinese.21128.768d.vec'
...
print ('(1) load texts...')
train_texts = open('D:/TBdata/mycorpus/random/01/traintext-ran3.txt', encoding='utf-8').read().split('\n')
train_labels = open('D:/TBdata/mycorpus/random/01/trainlabel-ran3.txt', encoding='utf-8' ).read().split('\n')
test_texts = open('D:/TBdata/mycorpus/random/01/testtext-ran3.txt', encoding='utf-8').read().split('\n')
test_labels = open('D:/TBdata/mycorpus/random/01/testlabel-ran3.txt', encoding='utf-8').read().split('\n')
...
BERT_DIR = "D:/TBdata/bert-base-cased/"
embeddings_index = {}
f = open(os.path.join(BERT_DIR, 'bert-base-cased.28996.768d.vec'))
for line in f:
    values = line.split()
    word = values[0]
